...
# Using kNN Imputer or Iterative Imputer impute the missing data in all columns
...
df_new = pd.DataFrame(X, columns = ['AtmosphericPressure','WindDirection','WindSpeed','Gust','WaveHeight','WavePeriod','AirTemperature','SeaTemperature','RelativeHumidity'])
